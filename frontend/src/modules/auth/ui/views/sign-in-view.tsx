    ...
    <div className="flex flex-col gap-6 text-green-700">
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className='p-6 md:p-8'>
              <div className='flex flex-col gap-6'>
                <div className='flex flex-col items-center text-center'>
                  <h1 className='text-3xl text-green-700 mb-2 font-bold'>Login</h1>
                ...
                <Button type='submit' className='w-full bg-green-700 hover:bg-green-900'>
                  Login 
                </Button>
          ...
          <div className="bg-radial from-green-700 to-green-900 relative hidden md:flex gap-y-4 items-center justify-center">
            <img src="/logo.svg" alt="logo" className="h-[102px] w-[102px] pe-5" />
